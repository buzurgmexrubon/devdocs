  ...
  return (
    ...
    >
      <div className="image-wrapper">
        <img
          src={useBaseUrl("/img/native/native-enterprise@2x.png")}
          width="476"
          height="228"
        />
      </div>
      ...
      <div className="heading-group">
        ...
        <p>
          Premium, supported plugins, third-party integrations, and pre-built
          native solutions for building enterprise-grade apps.
        </p>
      </div>
    </a>
  )
