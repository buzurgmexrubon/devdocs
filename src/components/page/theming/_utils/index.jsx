...
import { COLOR_NAMES } from "./color-variables"
...
export const generateProperty = (name) => `--ion-color-${name.toLowerCase()}`

export const convertCssToColors = (cssText) => {
...
const parseColorVar = (colorAttr, cssText) => {
