...
https://docs.github.com/en/enterprise-cloud@latest/authentication/authenticating-with-saml-single-sign-on/authorizing-a-personal-access-token-for-use-with-saml-single-sign-on`)
    ...
    return [
      <p>
        ...
        <a
          href="https://github.com/ionic-team/ionic/releases"
          target="_blank"
  ...
  return (
    <article>
      ...
      <p>
        ...
        <a href="/docs/reference/versioning">
          policy and commitment to stability
        </a>
        .
      </p>
          ...
          >
            <div className={styles["release-info"]}>
              <div className={styles["release-header"]}>
                <a
                  href={`https://github.com/ionic-team/ionic/releases/v${release.version}`}
                >
                  <h2>
