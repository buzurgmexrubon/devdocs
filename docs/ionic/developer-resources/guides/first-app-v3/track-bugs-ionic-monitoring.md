...
![An event showing error 'takePhoto is not a function' with status 'New'.](/ionic/img/guides/first-app-v3/monitoring-event.png "Ionic Monitoring Event Overview")
...
![Detailed view of an event log displaying a TypeError stack trace and error details such as device, browser, and operating system.](/ionic/img/guides/first-app-v3/monitoring-details.png "Detailed Ionic Monitoring Event Log")
