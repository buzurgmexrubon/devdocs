...
![An Ionic app's transformation from a blank 'Tab Two' to a 'Photo Gallery' with images.](/ionic/img/guides/first-app-v3/gallery-combined.png "Ionic App Before and After Photo Gallery")
...
![Animated GIF demonstrating the LiveReload feature in Ionic, showing real-time updates in the app after code changes.](/ionic/img/guides/first-app-v3/email-photogallery.gif "Ionic LiveReload Feature Demonstration")
