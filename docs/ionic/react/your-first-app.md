...
![Animated GIF showing the live reload feature in an Ionic app, with changes in code immediately updating the app in a web browser.](/ionic/img/guides/react/first-app/live-reload.gif "Live Reload Feature in Ionic App")
