...
![The Info.plist file in Xcode showing the NSCameraUsageDescription key added for camera access.](/ionic/img/guides/first-app-cap-ng/xcode-info-plist.png "Xcode Info.plist Configuration")
...
![The Xcode interface displaying the Signing and Capabilities tab for an iOS app project.](/ionic/img/guides/first-app-cap-ng/xcode-signing.png "Xcode Signing & Capabilities")
...
![Xcode toolbar highlighting the Build button used to compile and run an iOS app.](/ionic/img/guides/first-app-cap-ng/xcode-build-button.png "Xcode Build Button")
...
![Two iPhones side by side, one showing the camera permission prompt and the other displaying a photo taken with the app.](/ionic/img/guides/first-app-cap-ng/ios-permissions-photo.png "iOS Camera Permission Prompt and Photo Result")
...
![Android Studio editor showing the AndroidManifest.xml file with camera permissions.](/ionic/img/guides/first-app-cap-ng/android-manifest.png "Android Manifest Permissions")
...
![The Android Studio interface with arrows pointing to the Run button and the connected device.](/ionic/img/guides/first-app-cap-ng/android-device.png "Android Studio Run Configuration")
...
![Two Android phones side by side, one showing the camera permission prompt and the other displaying a photo taken with the app.](/ionic/img/guides/first-app-cap-ng/android-permissions-photo.png "Android Permissions and Photo Capture")
