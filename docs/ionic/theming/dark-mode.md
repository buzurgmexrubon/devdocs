...
import AlwaysDarkMode from '@site/static/ionic/usage/v8/theming/always-dark-mode/index.md';
...
import SystemDarkMode from '@site/static/ionic/usage/v8/theming/system-dark-mode/index.md';
...
import ClassDarkMode from '@site/static/ionic/usage/v8/theming/class-dark-mode/index.md';
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![A default light-themed scrollbar in an application interface.](/ionic/img/theming/color-scheme-light.png "Default scrollbar appearance without dark mode") | ![A dark-themed scrollbar in an application interface, demonstrating the effect of the 'color-scheme' property.](/ionic/img/theming/color-scheme-dark.png "Scrollbar appearance with dark mode 'color-scheme' applied") |
