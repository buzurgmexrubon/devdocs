...
| ------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------- |
| ![The light mode theme color in a browser interface.](/ionic/img/theming/theme-color-light.png "Light Mode Theme Color") | ![The dark mode theme color in a browser interface.](/ionic/img/theming/theme-color-dark.png "Dark Mode Theme Color") |
...
| Portrait                                                                             | Landscape                                                                              |
| ------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------- |
| <img src={require('@site/static/ionic/img/theming/ios-portrait-top.png').default} /> | <img src={require('@site/static/ionic/img/theming/ios-landscape-left.png').default} /> |
...
<img src={require('@site/static/ionic/img/theming/modal-header-padding.png').default} />
