...
![The Google Play Store Developer Console with the 'CREATE APPLICATION' button highlighted.](/ionic/img/publishing/newAppGPlay.png "Google Play Store Create Application Button")
