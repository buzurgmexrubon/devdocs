...
![A web browser displaying the Ionic Vue home route with a header titled 'Blank' and a message 'Ready to create an app? Start with Ionic UI Components'.](/ionic/img/guides/vue/first-app/home-route.png "Ionic Vue Home Route Interface")
