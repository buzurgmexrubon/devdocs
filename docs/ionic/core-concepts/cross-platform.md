...
<img src={require('@site/static/ionic/img/building/cross-platform-items.png').default} />
...
<img src={require('@site/static/ionic/img/building/cross-platform-grid.png').default} />
...
<img src={require('@site/static/ionic/img/building/cross-platform-grid-fixed.png').default} />
