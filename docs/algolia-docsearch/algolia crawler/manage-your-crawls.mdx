...
<div className="uil-ta-center">
  <img
    src={useBaseUrl("img/algolia-docsearch/crawler-overview.png")}
...
<div className="uil-ta-center">
  <img
    src={useBaseUrl("img/algolia-docsearch/crawler-monitoring.png")}
    alt="Algolia Crawler creation page"
  />
</div>
...
<div className="uil-ta-center">
  <img
    src={useBaseUrl("img/algolia-docsearch/crawler-editor.png")}
    alt="Algolia Crawler creation page"
  />
</div>
...
<div className="uil-ta-center">
  <img
    src={useBaseUrl("img/algolia-docsearch/crawler-search-preview.png")}
    alt="Algolia Crawler creation page"
  />
</div>
...
<div className="uil-ta-center">
  <img
    src={useBaseUrl("img/algolia-docsearch/crawler-url-tester.png")}
